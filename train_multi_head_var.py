...
from utils.llm_utils import get_tokenizer, get_momodel, get_momodel_w, get_momodel_multi_head, get_momodel_multi_head_var
...
def main():
    ...
    model = get_momodel_multi_head_var(training_conf, tokenizer)
